...
| **Windows** | **v0.1.0-beta5** | [1tracker-v0.1.0-beta5_windows.tar.gz](https://dl.cloudsmith.io/public/pa2wlt/1tracker-beta/raw/names/1tracker-v0.1.0-beta5-msvc-wx32-10-tarball/versions/v0.1.0-beta5/1tracker-v0.1.0-beta5_msvc-wx32-10-x86.tar.gz) |
